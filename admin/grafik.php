  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-database"></i>Grafik</h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i>Grafik</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                    ...
                    <?php
                      ...
                      ?>	
                        <tr>
                          ...
                          <td>
                            <a href="grafik_detail.php?data=<?php echo $kode_jurusan;?>" 
