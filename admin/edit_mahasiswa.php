...
<?php include("includes/header.php") ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-10">
      ...
      enctype="multipart/form-data" action="konfirmasi_edit_mahasiswa.php">
        <div class="card-body">
      ...
      <div class="form-group row">
        ...
        id="nim" value="<?php echo $nim;?>" readonly="readonly">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <?php if($kode_jurusan==$kd_jur){?> selected="selected" 
        <?php }?>>
      ...
      ?>
        ...
        value="<?php echo $kode_hobi; ?>"
        <?php if(in_array($kode_hobi, $array_hobi)){?>checked="checked" 
        <?php }?>/> 
        <?php echo $hobi; ?></br>
        <?php }?>
      </div>
