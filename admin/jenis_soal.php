            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="tambah_jenis_soal.php" class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah Jenis Soal</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <div class="col-sm-12">
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      <th width="5%">No</th>
                      <th width="35%">Kode Jenis Soal</th>
                      <th width="35%">Jenis Soal</th>
